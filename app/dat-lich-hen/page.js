    ...
    <>
      <div className="min-h-[80vh] flex flex-col items-center justify-center bg-gradient-to-br from-[#f5fafd] to-[#eaf3fa] py-10">
        <div className="text-center mb-8">
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-2 tracking-wide">ĐẶT LỊCH HẸN</h2>
          <p className="text-base md:text-lg text-gray-700 italic mb-1">
            Vui lòng để lại thông tin, nhu cầu của quý khách.
          </p>
          <p className="text-base md:text-lg text-gray-700 italic -mt-2">
            Nha Khoa Kim sẽ liên hệ đến Quý Khách trong vòng <span className="font-bold">3 phút</span><br />
            <span className="text-sm">(Tổng đài hỗ trợ làm việc từ <span className="font-bold">7h30-23h30</span> mỗi ngày trừ Lễ, Tết)</span>
          </p>
        </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center space-x-6 mb-2">
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="gender" value="232" defaultChecked className="accent-blue-600 w-4 h-4" />
                <span className="ml-2 text-blue-700 font-semibold">Anh</span>
              </label>
              <label className="flex items-center cursor-pointer">
                <input type="radio" name="gender" value="233" className="accent-blue-600 w-4 h-4" />
              ...
              <div className="flex-1 flex flex-col">
                ...
                />
                 {nameError && !touched.name && (
                  <span className="text-red-500 text-sm mt-1 ml-1">{nameError}</span>
                )}
              </div>
              <div className="flex-1 flex flex-col">
                <input
                ...
                />
                {phoneError && (
                  <span className="text-red-500 text-sm mt-1 ml-1">{phoneError}</span>
                )}
              </div>
            </div>
            {/* Note */}
            ...
            <div className="w-full flex justify-center mt-2">
              ...
              >
                <svg className="w-6 h-6 mr-1 animate-pulse" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zM4.75 8a.75.75 0 01.75-.75h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 014.75 8zm0 4a.75.75 0 01.75-.75h4.5a.75.75 0 010 1.5h-4.5a.75.75 0 01-.75-.75z" clipRule="evenodd"></path></svg>
                ĐẶT LỊCH HẸN
              </button>
            </div>
          </form>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-2xl p-6 md:p-8 w-full max-w-md relative animate-fade-in-down">
            ...
            <h3 className="text-2xl font-bold text-[#005f9d] mb-4 text-center">ĐẶT HẸN THÀNH CÔNG</h3>
            <div className="text-gray-700 space-y-3">
              <p>Nha Khoa Kim sẽ liên hệ bạn trong vòng 3 phút.</p>
              <div>
                <p className="font-bold">Thời gian làm việc (trừ ngày Lễ/Tết)</p>
                <p>Thứ 2 ~ Thứ 7: 08h00 ~ 19h30</p>
                <p>Chủ Nhật: 08h00 ~ 16h00</p>
              </div>
              <p>Ngoài thời gian làm việc, Nha Khoa Kim sẽ liên hệ vào 8h-9h sáng hôm sau.</p>
            </div>
